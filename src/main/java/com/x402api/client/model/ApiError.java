...
public class ApiError {
  ...
  public ApiError detail(@javax.annotation.Nullable Object detail) {
    this.detail = detail;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, code, detail, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "code", "detail"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("status", "code", "detail"));
  }
