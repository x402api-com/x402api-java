...
import com.x402api.client.core.auth.Authentication;
import com.x402api.client.core.auth.HttpBasicAuth;
import com.x402api.client.core.auth.HttpBearerAuth;
import com.x402api.client.core.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.x402api.com";
    ...
    public ApiClient() {
        ...
        authentications.put("tenantApiKey", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.x402api.com)
     ...
     * @return a {@link com.x402api.client.core.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.x402api.client.core.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.x402api.client.core.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.x402api.client.core.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.x402api.client.core.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.x402api.client.core.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.x402api.client.core.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.x402api.client.core.ApiException If fails to update the parameters
     */
     ...
     * @throws com.x402api.client.core.ApiException If fail to serialize the request body object into a string
     */
